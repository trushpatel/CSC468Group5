...
//                     sh 'ssh -o StrictHostKeyChecking=no kcodd3@155.98.38.244 cd CSC468Group5'
                    sh 'ssh -o StrictHostKeyChecking=no kcodd3@155.98.38.244 CSC468Group5/docker-compose -f docker-compose.images.yml build'
                    sh 'ssh -o StrictHostKeyChecking=no kcodd3@155.98.38.244 CSC468Group5/docker-compose -f docker-compose.images.yml push'
                    sh 'ssh -o StrictHostKeyChecking=no kcodd3@155.98.38.244 curl 127.0.0.1:46233/v2/_catalog'
